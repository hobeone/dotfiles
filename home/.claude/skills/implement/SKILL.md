...
**Fast-path for in-scope sibling discoveries.** Skip the AskUserQuestion halt (but still note the discovery inline in the plan-vs-actual diff) when the discovery satisfies all three:
